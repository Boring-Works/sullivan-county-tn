...
is configured with Workers Scripts write access. CI runs Biome, TypeScript, Vitest, and the production
build first. Without that secret, CI still verifies the app but skips deploy so main does not show a
