        ...
        <div className="space-y-10 max-w-3xl">
                ...
                <table className="w-full font-body text-sm">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-5 py-3.5 text-brand-slate">Remembers banner dismissal</td>
          ...
          <section>
            ...
            <p className="font-body text-sm leading-relaxed text-brand-slate">
              Some pages include embedded content from third-party services, such as YouTube videos
              (loaded via privacy-enhanced youtube-nocookie.com) and Google Maps. These services are
              loaded only when you choose to interact with them (click-to-load). Once loaded, these
              services may collect data about you, use cookies, and monitor your interaction
          ...
          <section>
            ...
            <p className="font-body text-sm leading-relaxed text-brand-slate">
              Contact form submissions are retained for 90 days and then automatically deleted. No
              user accounts, comment systems, or persistent personal data storage exist on this
              website.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="rounded-sm border border-brand-surface bg-brand-parchment p-5">
              <p className="font-body text-sm leading-relaxed text-brand-slate">
                ...
                that we delete any personal data associated with your contact form submissions. To
                make a request, please{" "}
                <Link
                  to="/contact"
                  className="text-brand-copper hover:text-brand-copper-light hover:underline underline decoration-brand-copper/30 font-medium"
                >
                  contact us
                </Link>{" "}
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                <li>
                  ...
                  <a
                    ...
                    className="text-brand-copper hover:underline underline decoration-brand-copper/30"
                  >
                    Privacy Policy
                  </a>
                  )
          ...
          <section>
            ...
            <p className="font-body text-sm leading-relaxed text-brand-slate">
              This privacy policy may be updated periodically to reflect changes to our website or
              legal requirements. The effective date will be noted when changes are made.
            </p>
            <p className="mt-3 font-body text-xs text-brand-stone">Last updated: March 2026</p>
          </section>
        </div>
      </div>
    </main>
