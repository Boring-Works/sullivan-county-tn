...
function TransportationPage() {
  ...
  return (
    <main id="main-content">
      ...
      <section className="bg-brand-parchment py-12 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-sm border border-brand-brass/20 bg-white p-6 shadow-sm">
            ...
            <h2 className="mt-2 font-display text-2xl font-bold text-brand-navy">
              Check roads before you travel
            </h2>
            <p className="mt-2 max-w-3xl font-body text-sm leading-relaxed text-brand-slate-light">
              TDOT SmartWay and TN 511 provide official Tennessee road conditions, closures,
              construction, incidents, and camera views for I-81, I-26, and nearby routes.
            </p>
