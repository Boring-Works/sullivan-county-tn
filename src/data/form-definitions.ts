...
export const FORM_DEFINITIONS: FormDefinition[] = [
	...
	},
	{
		...
		fields: [
			...
			},
			{
				...
				helpText:
					"If you have photos, a county inspector may contact you to collect them.",
			},
		],
	},
	{
		...
		fields: [
			{
				...
				required: true,
				placeholder:
					"Describe the records you are requesting as specifically as possible...",
			},
			{
				name: "dateRange",
	...
	},
	{
		...
		description:
			"Share feedback, suggestions, or concerns with Sullivan County government.",
		icon: "message-square",
		fields: [
			{
				name: "department",
